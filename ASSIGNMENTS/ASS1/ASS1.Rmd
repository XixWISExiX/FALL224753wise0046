...
a <- vtn[vtn > 8 & vtn <=8+inc]/nrow(old)
b <- vtn[vtn > 8+inc & vtn <=8+inc*2]/nrow(old)
c <- vtn[vtn > 8+inc*2 & vtn <=8+inc*3]/nrow(old)
d <- vtn[vtn > 8+inc*3 & vtn <=8+inc*4]/nrow(old)
e <- vtn[vtn > 8+inc*4 & vtn <=8+inc*5]/nrow(old)
f <- vtn[vtn > 8+inc*5 & vtn <=8+inc*6]/nrow(old)
g <- vtn[vtn > 8+inc*6 & vtn <=8+inc*7]/nrow(old)
h <- vtn[vtn > 8+inc*7 & vtn <=8+inc*8]/nrow(old)
i <- vtn[vtn > 8+inc*8 & vtn <=8+inc*9]/nrow(old)
